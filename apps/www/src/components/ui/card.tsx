  ...
  return (
    <div
      ...
      className={cn(
        ...
        // Premium Variant - Double Border Aesthetic
        variant === 'premium' && [
          'border border-foreground/10', // Outer line
          'ring-1 ring-black/5 dark:ring-black/40 ring-inset', // Inner separator
          'shadow-[inset_0_1px_0_0_rgba(255,255,255,0.1)] dark:shadow-[inset_0_1px_0_0_rgba(255,255,255,0.05)]', // Top highlight
        ],
        className,
      )}
      {...props}
